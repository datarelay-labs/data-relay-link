...
grep -q 'drlink create enrollment --one-line --ssh --note client-01' "$WORKDIR/help.out" || fail "help interactive example"
grep -q 'drlink create enrollment --one-line --ssh --ssh-user aella' "$WORKDIR/help.out" || fail "help explicit example"
