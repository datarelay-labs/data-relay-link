...
need "$WORKDIR/guide.out" 'Target host is the service machine' 'target host heading'
need "$WORKDIR/guide.out" '127.0.0.1' 'local target example'
need "$WORKDIR/guide.out" 'another server reachable on the LAN' 'remote internal target'
