...
```bash
curl -fsSL https://raw.githubusercontent.com/xdr-labs/frp-auto-deploy/v2.1.1/dist/bootstrap-server.sh \
| sudo env \
...
```bash
curl -fsSL https://raw.githubusercontent.com/xdr-labs/frp-auto-deploy/v2.1.1/dist/bootstrap-client.sh \
