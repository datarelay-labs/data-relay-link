...
ROOTS = (
    ("status", "any", "General", "Host status"),
    ("version", "any", "General", "Installed versions"),
    ("zero-touch", "server", "Remote Access", "Zero-Touch client onboarding"),
    ("enrollment", "server", "Remote Access", "Enrollment credentials"),
    ("client", "any", "Remote Access", "Registered clients and local client info"),
    ("service", "client", "Remote Access", "Local published services"),
    ("group", "server", "Organization", "Client groups"),
    ("service-profile", "server", "Organization", "Reusable service creation templates"),
    ("access", "server", "Security", "Access Control Pack (inbound source policy)"),
    ("egress", "server", "Security", "Controlled Egress (outbound proxy policy)"),
    ("server", "server", "Operations", "Server settings and server-side views"),
    ("backup", "server", "Operations", "Backup and restore"),
    ("update", "any", "Operations", "Update project tools or the FRP engine"),
    ("doctor", "any", "Operations", "Run health checks"),
    ("support", "any", "Operations", "Sanitized diagnostic archive"),
    ("help", "any", "General", "Detailed help"),
    ("menu", "any", "General", "Guided numbered menu"),
    ("history", "any", "General", "Session command history"),
    ("clear", "any", "General", "Clear the screen"),
    ("exit", "any", "General", "Leave the CLI"),
)
