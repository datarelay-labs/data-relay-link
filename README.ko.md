...
> **브랜치 상태:** 이 트리는 **v2.4.0 final-product-closure** 후보입니다. 안정 릴리스로 취급하지 마세요. 게시된 stable line은 **v2.3.0**입니다. v2.4 모델/문서의 상세 내용은 영문 [README.md](README.md)를 기준으로 합니다.
...
| **Single Operator Interface** | 일반 운영은 `sudo drlink`로 관리 |
