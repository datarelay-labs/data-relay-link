...
if PROJECT_VERSION="$PROJECT_VERSION" FRP_VERSION="$FRP_VERSION" TAG="$TAG" python3 - <<'PY'
import json
import os
import sys
...
RELEASE_DOCS=(README.md CHANGELOG.md docs/RELEASE_CHECKLIST.md docs/RELEASE_VALIDATION.md
  docs/SECURITY.md docs/PRODUCT_MASTER.md docs/FRP_UPGRADE.md GITHUB_SETUP.md)
