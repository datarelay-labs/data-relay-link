...
> **User E2E qualification:** [User E2E Test Scenarios](docs/e2e/USER_E2E_TEST_SCENARIOS.md) — canonical FULL_USER_E2E execution matrix (role, security, and performance scenarios) plus the v2.4 operator manual runbook.
